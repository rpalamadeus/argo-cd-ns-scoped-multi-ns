...
func NewCommand() *cobra.Command {
	...
	command := cobra.Command{
		...
		RunE: func(c *cobra.Command, args []string) error {
			...
			newControllerInstance(ctx, namespacedModeMultiNamespaceEnabled, applicationNamespaces, applicationSetNamespaces, k8sClient, namespace, scmRootCAPath, allowedScmProviders, enableScmProviders, tokenRefStrictMode, repoServerTimeoutSeconds, tlsConfig, mgr, dynamicClient, webhookMux, webhookParallelism, enableNewGitFileGlobbing, policyObj, enablePolicyOverride, enableProgressiveSyncs, globalPreservedAnnotations, globalPreservedLabels, maxConcurrentReconciliations, metrics)
